...
parser.add_argument('--label', type=str, default=None)  # optional
parser.add_argument('--time', type=str, default=None)   # 新增 time
...
# ==========================================================
# Robust mean / median
#   1) 排除使用者指定的 index / label / time 欄位（若存在）
#   2) 僅針對 numeric 欄位計算
# ==========================================================
exclude_cols = set()
...
if time_col_name is not None and time_col_name in df_source.columns:
    exclude_cols.add(time_col_name)
